...
const ContactoPage = () => {
    ...
    const handleChange = (e) => {
        ...
        setErrors({ ...errors, [e.target.name]: null }); // Limpiar errores al escribir
        setSubmissionMessage(null); // Limpiar mensaje de envío al modificar el formulario
    };
    ...
    const handleSubmit = async (e) => {
        ...
        if (Object.keys(newErrors).length === 0) {
            try {
                // Simulación de envío a un servidor (reemplazar con tu lógica real)
        ...
        <>
            ...
            <Layout>
                <div className={styles.container}>
                    ...
                    {submissionMessage && <div className={styles.submissionMessage}>{submissionMessage}</div>}
